        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    @la_input($module, 'name', null, null, "form-control text-uppercase", ["placeholder" => "Role Name
                    in CAPITAL LETTERS with '_' to JOIN e.g. 'SUPER_ADMIN'"])
                    ...
                    <div class="form-group">
                        {!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <a
                                href="{{ url(config('laraadmin.adminRoute') . '/roles') }}"

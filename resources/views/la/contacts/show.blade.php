...
@section('main-content')
    <div id="page-content" class="profile2">
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
            <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contacts') }}" data-toggle="tooltip"
                            data-placement="right" title="Back to Contacts"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <li class=""><a role="tab" data-toggle="tab" href="#tab-opportunities" data-target="#tab-opportunities"><i
                            class="fa {{ Module::get('Opportunities')->fa_icon }}"></i> Opportunities</a></li>
        </ul>

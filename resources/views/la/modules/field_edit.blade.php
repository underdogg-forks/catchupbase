                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="form-group values">
                        ...
                        <div class="radio" style="margin-bottom:20px;">
                            <label>{{ Form::radio("popup_value_type", "table", $popup_value_type_table) }} From
                                Table</label>
                            <label>{{ Form::radio("popup_value_type", "list", $popup_value_type_list) }} From
                                List</label>
                        </div>
                    ...
                    <div class="form-group">
                        {!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <a
                                href="{{ url(config('laraadmin.adminRoute') . '/modules/'.$module->id) }}"

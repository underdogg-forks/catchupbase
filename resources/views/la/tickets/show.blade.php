    ...
    <div id="page-content" class="profile2">
        <div class="bg-primary clearfix">
            ...
            <div class="col-md-1 actions">
                ...
                <a href="{{ url(config('laraadmin.adminRoute') . '/tickets/'.$ticket->id.'/edit') }}"
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
            <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/tickets') }}" data-toggle="tooltip"
                            data-placement="right" title="Back to Tickets"><i class="fa fa-chevron-left"></i></a></li>
